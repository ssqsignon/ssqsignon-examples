angular.module('tinyUsersExampleApp', [ 'ui.bootstrap', 'angular-ssqsignon', 'ngResource' ])
    .config(function(authenticatorProvider, $httpProvider, $locationProvider) {
        $locationProvider.html5Mode(true);
        authenticatorProvider.init('cat-and-dog', 27, undefined, 'https://tinyusers.azurewebsites.net');
